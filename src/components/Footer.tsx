        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 lg:gap-12">
          ...
          <div>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold transition-all duration-200"
              style={{ 
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <a 
                ...
                aria-label="Ligar para (45) 99804-4188"
              >
                (45) 99804-4188
              </a>
            </div>
