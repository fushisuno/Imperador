          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              ...
              <h2 className="text-4xl sm:text-5xl font-normal mb-6" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                ...
                <span style={{ background: 'linear-gradient(180deg, #f0a820 0%, #e8c040 50%, #c8800e 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>desde 2017</span>
              </h2>
              </Scroll>
              ...
              <div className="inline-flex items-center gap-3 px-5 py-3" style={{ backgroundColor: 'rgba(200,146,30,0.08)', border: '1px solid rgba(200,146,30,0.2)' }}>
                ...
                <span className="text-sm" style={{ color: 'rgba(42,31,20,0.7)', fontFamily: 'Inter, sans-serif', fontWeight: 400 }}>Mais de 8 anos de história no chopp premium paranaense</span>
              </div>
              </Scroll>
            </div>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-base" style={{ color: 'rgba(200,185,145,0.6)', fontFamily: 'Inter, sans-serif', fontWeight: 300 }}>
              Confirmada em 2024: uma das principais referências de chopp premium na região.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #c8921e 0%, #e0a820 50%, #b87a10 100%)' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <motion.a href="https://wa.me/554599954660" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} className="inline-flex items-center gap-3 px-10 py-5 text-base font-bold uppercase transition-all duration-300" style={{ backgroundColor: '#0d0a04', color: '#d4a820', fontFamily: 'Oswald, sans-serif', letterSpacing: '2px', clipPath: 'polygon(12px 0%, 100% 0%, calc(100% - 12px) 100%, 0% 100%)' }}>
