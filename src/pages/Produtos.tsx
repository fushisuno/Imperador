...
const products = produtos.map((p, i) => ({
  ...
  ibu: 12 + i * 5,
  abv:
    p.categoria === "Chopp" ? "4.8%" : p.categoria === "Barril" ? "4.5%" : "0%",
  temperature: "0–4°C",
  badge: i === 0 ? "Mais pedido" : null,
  badgeType: (i % 2 === 0 ? "primary" : "dark") as "primary" | "dark",
  image: p.imagem,
  volumes: p.features,
}));
...
const equipment = [
  {
    ...
    description:
      "Serve duas variações de chopp ao mesmo tempo com controle independente de temperatura.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
      ...
      >
        <path
          ...
          d="M9 3v2m6-2v2M9 19v2m6-2v2M5 3H3m2 0h14v14H3V3zm2 0v14m8-14v14m0-14v14"
        />
      </svg>
    ),
    isCta: false,
  },
  {
    ...
    description:
      "Barril de alta pressão com válvula profissional e sistema de CO2 integrado.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4l8-4M4 7v10m8-4v4"
        />
      </svg>
    ),
    isCta: false,
  },
  {
    ...
    description:
      "Ideal para grandes eventos, com maior rendimento e sistema de refrigeração eficiente.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    subtitle: "Alta Capacidade",
    description:
      "Sistema profissional para grandes eventos com até 4 diferentes tipos de chopp simultâneos.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M4 4v8m0 0h8m8 0v8m0 0H4m8-16v8m0 0H4m8-8v8m0 0H4m8-8V4"
        />
      </svg>
    ),
    isCta: false,
  },
  {
    ...
    description:
      "Tudo o que você precisa: chopeiro, barris, copas e acessórios para servir.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Fale com nossa equipe para encontre a melhor solução para seu evento.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
...
{/* Right Side - Background */}
      ...
      {showEquipment && (
        ...
        >
          ...
          >
            <span
              className="text-[120px] font-normal leading-none"
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              Estrutura profissional completa para tornar seu evento
              inesquecível.
            </p>
                ...
                <motion.div
                  ...
                  style={{
                    backgroundColor: item.isCta
                      ...
                      : "rgba(200,146,30,0.03)",
                    border: item.isCta
                      ? "1px solid rgba(200,146,30,0.35)"
                      : "1px solid rgba(200,146,30,0.12)",
                  }}
                >
                  <div className="p-6">
                    {/* Icon */}
                  ...
                  <div
                    ...
                    style={{
                      borderBottom: "2px solid rgba(200,146,30,0.3)",
                      borderRight: "2px solid rgba(200,146,30,0.3)",
                    }}
                  ></div>
                </motion.div>
              ))}
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #c8921e 0%, #e0a820 50%, #b87a10 100%)",
        }}
      >
        <div
          className="absolute right-0 top-1/2 -translate-y-1/2 text-[100px] font-normal leading-none pointer-events-none select-none"
          style={{
            fontFamily: "Bebas Neue, sans-serif",
            color: "rgba(13,10,4,0.06)",
          }}
        >
          IMPERADOR
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              ...
              >
                Estamos prontos para ajudar a encontrar a melhor solução para
                seu evento.
              </p>
            </div>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 px-8 py-4 text-base font-bold uppercase transition-all duration-300"
              style={{
