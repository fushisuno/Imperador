...
const eventTypes = [
  {
    ...
    title2: "Sociais",
    description:
      "Aniversários, batizados, formaturas e celebrações. O chopp que todo mundo ama, sem você precisar se preocupar com nada.",
    benefits: [
  ...
  },
  {
    ...
    title2: "Corporativos",
    description:
      "Confraternizações, lançamentos e eventos empresariais. Profissionalismo e qualidade no serviço.",
    benefits: [
  ...
  },
  {
    ...
    title2: "Restaurantes",
    description:
      "Parceria de fornecimento contínuo com suporte técnico. Seu estabelecimento sempre bem atendido.",
    benefits: [
  ...
  },
  {
    ...
    title2: "e Festas",
    description:
      "O dia mais especial merece o melhor chopp. Estrutura completa para não se preocupar com nada.",
    benefits: ["Chopeiras temáticas", "Montagem antecipada", "Equipe completa"],
    images: [
...
function Home() {
  ...
  const allProducts = [
    ...
    },
    {
      ...
      type: "Trigo",
      image:
        "https://images.unsplash.com/photo-1519671482749-fd09a3885e67?w=400&h=400&fit=crop",
      desc: "Aromática e citrus",
    },
    {
      name: "Vienna",
      category: "chopp",
      type: "Amber",
      image:
        "https://images.unsplash.com/photo-1505236858219-9a1753776f75?w=400&h=400&fit=crop",
      desc: "Malte caramelizado",
    },
    {
      name: "IPA",
      category: "chopp",
    ...
    },
    {
      ...
      type: "Pequeno",
      image:
        "https://images.unsplash.com/photo-1560132587-2e828a067b2c?w=400&h=400&fit=crop",
      desc: "Eventos pequenos",
    },
    {
      name: "Barril 30L",
      category: "barril",
  ...
  const getFilteredProducts = useCallback(
    () =>
      allProducts.filter(
        (p) =>
          activeProductFilter === "all" || p.category === activeProductFilter,
      ),
    [activeProductFilter],
  );
    ...
    const interval = setInterval(() => {
      if (!isPaused && carouselRef.current) {
        ...
        if (carouselRef.current.scrollLeft >= maxScroll - 10) {
          ...
          setCurrentDot((prev: number) =>
            Math.min(prev + 1, getFilteredProducts().length - 1),
          );
        }
      }
    }, 3000);
  ...
  }, [isPaused, activeProductFilter, scrollCarousel, getFilteredProducts]);

  const currentContent =
    eventTypes.find((t) => t.id === activeTab) || eventTypes[0];
    ...
    <div>
      ...
      <section className="relative h-[90vh] flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, rgba(20, 12, 0, 0.95) 0%, rgba(20, 12, 0, 0.8) 50%, rgba(20, 12, 0, 0.6) 100%)",
          }}
        />
      ...
      >
        <div className="absolute inset-0 pointer-events-none">
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(200,146,30,0.4) 0%, transparent 100%)",
            }}
          />
          <div
          ...
          >
            <div className="mb-8">
              <div className="relative">
                <div
                  className="w-44 h-44 lg:w-52 lg:h-52 rounded-3xl overflow-hidden relative"
                  style={{
                    backgroundColor: "#fff",
                    boxShadow: "0 20px 60px rgba(200,146,30,0.1)",
                  }}
                >
                  ...
                  <div
                    ...
                    style={{ borderColor: "rgba(200,146,30,0.2)" }}
                  />
                </div>
                <div
                  className="absolute -bottom-3 -right-3 w-20 h-20 rounded-xl flex items-center justify-center"
                  style={{
                    backgroundColor: "#c8921e",
                    boxShadow: "0 8px 24px rgba(200,146,30,0.3)",
                  }}
                >
                  <span
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(180deg, #f0a820 0%, #d4860e 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                }}
              >
            ...
            <p
              ...
              style={{ color: "#5a4a3a", lineHeight: 1.7 }}
            >
              Desde 2017 entregando chopp de qualidade em Cascavel e região.
              Atendimento honesto, estrutura completa e suporte até as 22h.
            </p>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: "0 4px 12px rgba(200,146,30,0.08)",
                  }}
                >
                  <svg
      ...
      >
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(200,146,30,0.1) 0%, transparent 70%)",
            }}
          />
        </div>
        ...
        <div className="relative max-w-6xl mx-auto px-5 lg:px-8">
          <Scroll>
            ...
            >
              ...
              >
                Estabelecimentos parceiros que servem chopp Imperador com
                qualidade
              </p>
            </motion.div>
          </Scroll>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                city: "Foz do Iguaçu",
                hours: "Ter-Dom: 17h-00h",
                phone: "(45) 99999-0002",
              },
              {
                name: "Boteco do Zé",
                address: "Praça da Matrix, 78 - Zona 01",
                city: "Cascavel",
                hours: "Qui-Sáb: 19h-03h",
                phone: "(45) 99999-0003",
              },
              {
                name: "Ponto do Chopp",
                address: "Av. Paraná, 890 - Jd. América",
                city: "Guarapuava",
                hours: "Qua-Dom: 18h-01h",
                phone: "(42) 99999-0004",
              },
              {
                name: "Bar da Esquina",
                ...
                city: "Maringá",
                hours: "Seg-Sáb: 17h-02h",
                phone: "(44) 99999-0005",
              },
              {
                name: "Chopp & Rock",
                address: "Av. das Cataratas, 567 - Vila Yolanda",
                city: "Foz do Iguaçu",
                hours: "Sex-Sáb: 19h-04h",
                phone: "(45) 99999-0006",
              },
            ].map((bar, i) => (
              <motion.div
              ...
              >
                ...
                <div
                  ...
                  style={{ borderColor: "rgba(200,146,30,0.1)" }}
                >
                  <a
      ...
      >
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              >
                ...
                >
                  onde a festa acontecer
                </span>
              </h2>

              <p
                className="text-base mb-2 leading-relaxed text-white"
                style={{ fontFamily: "Playfair Display, serif" }}
              >
                Pra um jantar em família, aniversário na garagem ou
                confraternização da firma, o Imperador leva o chopp até você com
                a mesma qualidade que usamos nos grandes eventos.
              </p>
              ...
              <div className="space-y-5 mb-8">
                {[
                  {
                    title: "Barris de 20L, 30L e 50L",
                    subtitle: "Escolha o tamanho ideal pro seu evento",
                  },
                  {
                    title: "Chopp sempre bem armazenado",
                    subtitle: "Temperatura ideal do início ao fim",
                  },
                  {
                    title: "Entrega agendada e suporte",
                    subtitle: "Sem surpresa de logística no dia",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
              ...
              <div className="relative flex items-center justify-end w-full h-full">
                ...
                >
                  <img
                    ...
                    style={{
                      maxWidth: "none",
                      filter: "drop-shadow(0 25px 50px rgba(200,146,30,0.35))",
                    }}
                  />
                </motion.div>
              </div>
          ...
          >
            ...
            >
              Você não contrata "só o chopp". Você leva junto estrutura,
              atendimento e segurança pra não passar perrengue no meio da festa.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              >
                {" "}
                chopp de qualidade em versão menor
              </span>
            </h2>
            ...
            >
              Nem todo momento pede barril, mas todo momento pode ficar melhor
              com chopp.
            </p>
            ...
            >
              Nossa linha de Growlers é perfeita pra quem quer levar chopp de
              qualidade pra casa, pra um jantar ou pra presentear alguém.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, transparent 60%, rgba(42,31,20,0.1) 100%)",
                  }}
                />
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                {/* Title */}
                <h3
                  className="text-2xl font-extrabold uppercase mt-3"
                  style={{
                    fontFamily: "Bebas Neue, sans-serif",
                    color: "#1A1208",
              ...
              >
                ...
                >
                  Leve e refrescante, ideal para dias quentes e eventos
                  informais.
                </p>
              </motion.div>
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse at 50% 50%, rgba(200,146,30,0.05) 0%, transparent 60%)",
          }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Scroll>
            ...
            >
              <div className="flex items-center justify-center gap-4 mb-4">
                <div
                  className="h-px w-12"
                  style={{ backgroundColor: "rgba(200,146,30,0.4)" }}
                ></div>
                <span
                  className="text-xs uppercase tracking-[0.3em]"
                  style={{ color: "#CA8A04", fontFamily: "Oswald, sans-serif" }}
                >
                  Catálogo
                </span>
                <div
              ...
              <h2
                className="text-4xl sm:text-5xl lg:text-6xl font-normal mb-4"
            ...
            >
              {[
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-5 py-2 text-xs font-medium transition-all duration-200"
                  style={{
                    backgroundColor:
                    ...
                    color:
                      activeProductFilter === filter.id ? "#1C1917" : "#FAFAF9",
                    border:
                      activeProductFilter === filter.id
                        ? "none"
                        : "1px solid rgba(200,146,30,0.3)",
                    fontFamily: "Oswald, sans-serif",
                    borderRadius: "6px",
                  }}
                >
          ...
          <div className="relative">
            ...
            <button
              ...
              style={{
                backgroundColor: "rgba(200,146,30,0.9)",
                color: "#1C1917",
              }}
            >
              <svg
            ...
            >
              {getFilteredProducts().map((product, i) => (
                <motion.div
                  ...
                  className="relative flex-shrink-0 w-[220px] rounded-xl overflow-hidden group cursor-pointer"
                  style={{
                    scrollSnapAlign: "start",
                    backgroundColor: "rgba(255,255,255,0.03)",
                    border: product.highlight
                      ? "2px solid #CA8A04"
                      : "1px solid rgba(200,146,30,0.15)",
                ...
                >
                  ...
                  {product.highlight && (
                    <div
                      className="absolute top-2 right-2 z-10 px-2 py-1 rounded-full text-[10px] font-bold"
                      style={{
                  ...
                  <div className="relative aspect-[3/4] overflow-hidden">
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, transparent 40%, rgba(28,25,23,0.9) 100%)",
                      }}
                    />
                  </div>
...
{/* Indicadores (dots) */}
              ...
              {getFilteredProducts().map((_, i) => (
                <button
                  ...
                  className={`
                    ...
                    ${currentDot === i ? 'w-2 h-2' : 'w-1.5 h-1.5'}
                  `}
                  style={{
          ...
          >
            <motion.a
              ...
              whileHover={{
                scale: 1.05,
                boxShadow: "0 10px 35px rgba(200,146,30,0.4)",
              }}
              whileTap={{ scale: 0.98 }}
            >
              <span>Conhecer linha completa</span>
      ...
      >
        ...
        <div className="relative h-[40vh] lg:h-[50vh] overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(28,25,23,0.2) 0%, rgba(28,25,23,0.6) 50%, rgba(28,25,23,0.95) 100%)",
            }}
          ></div>
          <div className="relative h-full flex flex-col justify-end pb-14 lg:pb-20">
            <div className="max-w-6xl mx-auto px-6 lg:px-8 w-full">
              ...
              >
                ...
                <h2
                  className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-normal leading-[0.95] mb-4"
                  style={{ fontFamily: "Bebas Neue, sans-serif" }}
                >
                ...
                <p
                  className="text-lg lg:text-xl max-w-2xl mb-4"
                  style={{
                    fontFamily: "Playfair Display, serif",
                    fontStyle: "italic",
                ...
                <p
                  className="text-sm lg:text-base max-w-xl mb-8"
                  style={{
                    color: "rgba(250,250,249,0.65)",
                    fontFamily: "Playfair Display, serif",
                  }}
                >
                  Chopp gelado, chopeira montada, suporte garantido até as 22h.
                  Você só cuida de brindar – o resto é com o Imperador.
                </p>
                <div className="flex flex-wrap gap-4">
                  <motion.a
                    href={`https://wa.me/${config.whatsapp}?text=Olá! Gostaria de informações sobre eventos`}
                    target="_blank"
                    rel="noopener noreferrer"
                    ...
                    whileHover={{
                      scale: 1.02,
                      boxShadow: "0 8px 30px rgba(200,146,30,0.4)",
                    }}
                    whileTap={{ scale: 0.98 }}
                  >
                    Quero chopp pro meu evento
                  ...
                  <motion.a
                    href={`https://wa.me/${config.whatsapp}?text=Olá! Quero revender Imperador`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 px-7 py-3 text-sm font-semibold"
                    style={{
          ...
          <div className="absolute bottom-6 right-8 lg:right-16 hidden lg:block">
            <span
              className="text-[10rem] xl:text-[12rem] font-bold leading-none"
              style={{
                fontFamily: "Bebas Neue, sans-serif",
                  ...
                  <div className="flex flex-wrap gap-3">
                    {[
                      ...
                      <motion.span
                        ...
                        whileHover={{
                          backgroundColor: "rgba(200,146,30,0.15)",
                          y: -2,
                        }}
                      >
                        {item}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-8">
                ...
                {eventTypes.map((tab) => (
                  <motion.button
                    ...
                    style={{
                      ...
                      backgroundColor:
                        activeTab === tab.id ? "#CA8A04" : "#ffffff",
                      border:
                        activeTab === tab.id
                          ? "none"
                          : "1px solid rgba(200,150,30,0.2)",
                      color: activeTab === tab.id ? "#1C1917" : "#1C1917",
                      borderRadius: "10px",
                    }}
                  >
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                  ...
                  <div>
                    <span
                      className="inline-block text-xs font-medium mb-3 px-4 py-1.5 rounded-full"
                      style={{
                        backgroundColor: "rgba(200,146,30,0.1)",
                        color: "#CA8A04",
                        fontFamily: "Oswald, sans-serif",
                    ...
                    <ul className="space-y-2.5 mb-6">
                      {currentContent.benefits.map((item, i) => (
                        <li key={i} className="flex items-center gap-3 text-sm">
                          ...
                          <span style={{ color: "rgba(42,31,20,0.7)" }}>
                            {item}
                          </span>
                        </li>
                      ))}
                    ...
                    <a
                      href={`https://wa.me/${config.whatsapp}?text=Olá! Gostaria de informações sobre ${currentContent.badge}`}
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  <div className="relative rounded-xl overflow-hidden aspect-[4/3]">
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, rgba(200,146,30,0.1) 0%, transparent 50%)",
                      }}
                    ></div>
                  </div>
                </div>
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <Scroll>
              ...
              >
                ...
                >
                  Momentos únicos servidos com qualidade Imperador
                </p>
              </motion.div>
            </Scroll>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="relative aspect-[9/12] rounded-2xl overflow-hidden group cursor-pointer"
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div
                      ...
                      style={{ backgroundColor: "rgba(200,146,30,0.9)" }}
                    >
                      <svg
                        className="w-8 h-8"
                        fill="#1C1917"
                  ...
                  {/* Badge de loop */}
                  <div
                    className="absolute top-3 right-3 px-2.5 py-1.5 rounded-full text-xs flex items-center gap-1.5"
                    style={{
        ...
        <div className="py-14 lg:py-18" style={{ backgroundColor: "#1C1917" }}>
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            >
              <p
                className="text-lg lg:text-xl max-w-2xl mx-auto mb-8 leading-relaxed"
                style={{
                  fontFamily: "Playfair Display, serif",
                  fontStyle: "italic",
              ...
              >
                "Você não precisa virar 'técnico de chopeira' da própria festa.
                Nós cuidamos disso pra você aproveitar do primeiro ao último
                brinde."
              </p>
              <motion.a
                href={`https://wa.me/${config.whatsapp}?text=Olá! Gostaria de fazer um orçamento para evento`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-8 py-4 text-base font-bold"
                style={{
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              >
                viraram atração do evento
              </span>
            </h2>

            <p
              className="text-sm max-w-xl mx-auto"
              style={{ color: "#5a4a3a", lineHeight: 1.6 }}
            >
              Além da qualidade do chopp, a gente também cuida da experiência
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundColor: "#fff",
                border: "1px solid rgba(200,146,30,0.2)",
                boxShadow: "0 15px 40px rgba(200,146,30,0.1)",
              }}
            >
                ...
                >
                  <div className="p-8 lg:p-10 flex flex-col justify-center">
                    ...
                    <p
                      ...
                      style={{ color: "rgba(42,31,20,0.7)" }}
                    >
                      A queridinha dos eventos! Modelo temático em formato de
                      moto que chama atenção e vira o point de foto da festa.
                    </p>
                  ...
                  <div
                    className="bg-gradient-to-br from-amber-50 to-amber-100/50 p-8 lg:p-10 flex items-center justify-center"
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M15 62c0-18 18-28 35-28s35 10 35 28"
                        stroke="#c8921e"
                        strokeWidth="3"
                        strokeLinecap="round"
                        fill="rgba(200,146,30,0.1)"
                      />
                      <path
                        d="M12 45h76v15c0 8-15 15-38 15S12 68 12 60V45z"
                        stroke="#c8921e"
                        strokeWidth="3"
                        fill="none"
                      />
                      <path
                        d="M18 45V30c0-6 10-12 32-12s32 6 32 12v15"
                        stroke="#c8921e"
                        strokeWidth="3"
                        fill="none"
                      />
                ...
                >
                  <div className="p-8 lg:p-10 flex flex-col justify-center">
                    ...
                    <p
                      ...
                      style={{ color: "rgba(42,31,20,0.7)" }}
                    >
                      A escolha certeira pra qualquer evento. Tradicional, fácil
                      de usar e combina com tudo.
                    </p>
                    <div className="flex flex-wrap gap-2 mb-6">
                      {[
                        "Tradicional",
                        ...
                        <span
                          ...
                          className="px-3 py-1.5 rounded-full text-xs font-medium"
                          style={{
                            backgroundColor: "rgba(139,115,72,0.1)",
                            color: "#2a1f14",
                          }}
                        >
                          {tag}
                  ...
                  <div
                    className="bg-gradient-to-br from-stone-50 to-stone-100/50 p-8 lg:p-10 flex items-center justify-center"
                    style={{ minHeight: "280px" }}
                  >
                    <svg
                      className="w-40 h-48"
                    ...
                    >
                      ...
                      <rect
                        ...
                        stroke="#8a7348"
                        strokeWidth="3"
                        fill="rgba(139,115,72,0.08)"
                      />
                      <path
                        d="M25 45V30c0-7 14-14 25-14s25 7 25 14v15"
                        stroke="#8a7348"
                        strokeWidth="3"
                        fill="none"
                      />
                      <rect
                        ...
                        stroke="#8a7348"
                        strokeWidth="2"
                        fill="rgba(139,115,72,0.1)"
                      />
                      <path
                        d="M40 80l20 22M60 80L40 102"
                        stroke="#8a7348"
                        strokeWidth="3"
                        strokeLinecap="round"
                      />
                ...
                >
                  <div className="p-8 lg:p-10 flex flex-col justify-center">
                    ...
                    <p
                      ...
                      style={{ color: "rgba(42,31,20,0.7)" }}
                    >
                      Tem uma ideia? A gente cria! do tema da festa ao branding
                      do seu negócio, fazemos sob medida.
                    </p>
                    <div className="flex flex-wrap gap-2 mb-6">
                      {[
                        "Exclusiva",
                  ...
                  <div
                    className="bg-gradient-to-br from-amber-50 to-stone-100/50 p-8 lg:p-10 flex items-center justify-center"
                    style={{ minHeight: "280px" }}
                  >
                    <svg
                      className="w-40 h-48"
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(200,146,30,0.15) 0%, transparent 60%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(200,146,30,0.1) 0%, transparent 60%)",
            }}
          />
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12 relative z-10">
          <Scroll>
            ...
            >
              ...
              >
                <div
                  className="h-px w-16"
                  style={{ backgroundColor: "rgba(200,146,30,0.5)" }}
                />
                <span
                  className="text-xs font-medium uppercase tracking-[4px]"
                  style={{ color: "#c8921e", fontFamily: "Oswald, sans-serif" }}
                >
                  Por que escolher
                </span>
              ...
              <h2 className="text-5xl lg:text-7xl font-normal leading-tight">
                ...
                <span
                  style={{
                    background:
                      "linear-gradient(180deg, #d4a420 0%, #c8921e 50%, #a67814 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                  }}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6">
            {[
              ...
              >
                <div
                  className="absolute inset-0 rounded-16 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(200,146,30,0.1) 0%, transparent 60%)",
                  }}
                />
                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div
                      className="w-10 h-10 rounded-lg flex items-center justify-center opacity-60 group-hover:opacity-100 transition-opacity"
                      style={{ backgroundColor: "rgba(200,146,30,0.15)" }}
                    >
                      <div className="w-5 h-5" style={{ color: "#c8921e" }}>
                        {item.icon}
                      </div>
                    </div>
                  </div>
                  ...
                  <h3
                    className="text-xl lg:text-2xl font-normal mb-3 group-hover:text-[#c8921e] transition-colors duration-300"
                    style={{
                      fontFamily: "Bebas Neue, sans-serif",
                      color: "#faf8f4",
                    }}
                  ...
                  <p
                    className="text-sm leading-relaxed group-hover:text-white transition-colors duration-300"
                ...
                <div
                  className="absolute -bottom-px left-1/2 -translate-x-1/2 w-0 h-0.5 group-hover:w-full transition-all duration-500 rounded-full"
                  style={{ backgroundColor: "#c8921e" }}
                />
              </motion.div>
            ))}
      ...
      >
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(200,146,30,0.05) 0%, transparent 70%)",
            }}
          />
        </div>
              ...
              <Scroll>
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "rgba(42,31,20,0.7)" }}
                  >
                    O Imperador do Chopp atua em todo o Paraná com{" "}
                    <strong style={{ color: "#c8921e" }}>
                      4 sedes estratégicas
                    </strong>
                    , garantindo atendimento rápido e qualidade em cada região.
                  </p>
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 flex flex-col gap-2">
                    ...
                    >
                      <div
                        className="w-3 h-3 rounded-full"
                        style={{ backgroundColor: "#c8921e", opacity: 0.5 }}
                      ></div>
                      <span
                        className="text-xs"
                        style={{
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(200,146,30,0.2) 0%, transparent 60%)",
            }}
          />
          <div
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12 relative z-10">
          <Scroll>
            ...
            >
              ...
              >
                Torne-se parte da maior rede de distribuição de chopp premium do
                Paraná
              </p>
            </motion.div>
          </Scroll>
              ...
              >
                <div className="relative z-10">
                  <div
                    ...
                    style={{ backgroundColor: "rgba(200,146,30,0.12)" }}
                  >
                    <div className="w-7 h-7" style={{ color: "#c8921e" }}>
                      {item.icon}
                    </div>
                  </div>
